  ...
  <div class="container-fluid">
    <div class="row">
      <div class="container">
        ...
        <div class="col-md-2">
          <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal" class="btn btn-dark" style="position: absolute;">Add User</a>
        </div>
        <div class="col-md-2">
          <a href="#!" data-id="" class="btn btn-dark" style="position: absolute; margin-left: 120px;">Filter</a>
        </div>
        <div class="row">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#example').DataTable({
        ...
        'order': [],
        'ajax': {
          'url': 'adminView/stock/fetch_data.php',
          'type': 'post',
        },
        "aoColumnDefs": [{
            "bSortable": false,
    ...
    $(document).on('submit', '#addUser', function(e) {
      ...
      if (city != '' && username != '' && mobile != '' && email != '') {
        $.ajax({
          url: "adminView/stock/add_user.php",
          type: "post",
          data: {
            city: city,
            username: username,
    ...
    $(document).on('submit', '#updateUser', function(e) {
      ...
      if (city != '' && username != '' && mobile != '' && email != '') {
        $.ajax({
          url: "adminView/stock/update_user.php",
          type: "post",
          data: {
            city: city,
            username: username,
    ...
    $('#example').on('click', '.editbtn ', function(event) {
      ...
      $.ajax({
        url: "adminView/stock/get_single_data.php",
        data: {
          id: id
        },
        type: 'post',
    ...
    $(document).on('click', '.deleteBtn', function(event) {
      ...
      if (confirm("Are you sure want to delete this User ? ")) {
        $.ajax({
          url: "adminView/stock/delete_user.php",
          data: {
            id: id
          },
          type: "post",
